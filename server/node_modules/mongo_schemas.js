...
module.exports = (function() {
    ...
    _return.rememberance = mongoose.model('rememberance',
        rememberance_schema);
    ...
    // sms
    _return.send_sms_archive = mongoose.model('send_sms_archive',
        send_sms_archive_schema);
    _return.income_sms_archive = mongoose.model('income_sms_archive',
        income_sms_archive_schema);
    // _return.sms_counter = mongoose.model('sms_counter', sms_counter_schema);
    _return.birthday_sms = mongoose.model('birthday_sms',
        birthday_sms_schema);
