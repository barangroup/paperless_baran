...
var users_schema = Schema({
    ...
    telephone_number : { type : String ,trim : true } ,
    password : String ,
    gender : Boolean ,
    ...
    _comments : [
        {
            ...
            _writer : { type: ObjectId, ref: 'users' }
        }
    ],
...
var tasks_schema = Schema({
    ...
    permissions : [
        ...
        "mali_dispatch", // mali part
        "add_cost", // add hazine
        "mali_api" ,
        "mali_report",
        "see_all_mali_notification",
    ],
    _parent : { type: ObjectId, ref: 'tasks' } ,
    _disable : Boolean
});
...
var dispatch_schema = Schema({ // ezam
    ...
    _leader : { type: ObjectId, ref: 'users' } ,
    _station : { type: ObjectId, ref: 'stations' }
});
...
var stations_schema = Schema({
    ...
    age_from : Number ,
    age_to : Number ,
    phone_numbers : [{ type: String ,trim : true }],
...
//var mali_schema = Schema({ // todo : this is an idea
//    comment : String ,
//    pony : Boolean ,
//    _owner : { type: ObjectId, ref: 'users' } ,
//    _dispatch : { type: ObjectId, ref: 'tasks' }
//});
...
module.exports = (function () {
    ...
    // _return.mali = mongoose.model('mali_api', mali_api_schema);
