...
app.controller('MainController', ['$scope', '$http', '$location', '$timeout',
    ...
    function($scope, $http, toaster) {
        ...
        $scope.nominated = [{
            ...
            name: "خانم شریعتمداری",
            votes: 0,
            precent: 0,
            rank: 0
        }, {
            name: "خانم محمدی تبار",
            votes: 0,
            precent: 0,
            rank: 0
        }, {
    ...
    function($scope, $http, toaster) {
        ...
        $scope.nominated = [{
            url: "http://10.0.0.14:8080/videofeed"
        }, {
            url: "http://10.0.0.12:8080/videofeed"
        }, {
            url: "http://10.0.0.8:8080/videofeed"
        }, {
            url: "http://10.0.0.6:8080/videofeed"
        }];
