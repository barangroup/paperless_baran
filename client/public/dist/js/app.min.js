...
// my function
$(document).ready(function(){$(window).scrollTop()<150&&$("a.scrollToTop").fadeOut(500),$("a.scrollToTop").click(function(){return $("html, body").animate({scrollTop:0},"300"),!1})}),$(window).scroll(function(){$(window).scrollTop()>=150?$("a.scrollToTop").is(":visible")||$("a.scrollToTop").fadeIn(500):$("a.scrollToTop").fadeOut(500)}),$(document).ready(function(){$(".modal .close").click(function(){$(this).parents(".modal-dialog").slideUp("slow",function(){$(this).parents(".modal").hide()})})});
